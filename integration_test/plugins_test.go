...
`, testProjectDir, pluginName)
	...
	gotOutput = execCommand(t, testProjectDir, "./godelw", "verify", "--skip-lint", "--skip-license", "--skip-test", "--skip-distgo-task")
...
`, testProjectDir, testProjectDir, testProjectDir, pluginName)
	...
	gotOutput = execCommand(t, testProjectDir, "./godelw", "verify", "--skip-lint", "--skip-license", "--skip-test", "--skip-distgo-task", "--apply=false")
	wantOutput = fmt.Sprintf(`Running format...
Running echo-task...
