...
--- PASS: TestInvalidType (3.16s)
PASS
ok  	github.com/nmiyake/echgo2/integration_test	3.167s
```
...
=== RUN   TestInvalidType
"invalid echo type: invalid\n"
--- FAIL: TestInvalidType (3.02s)
	integration_test.go:23: cmd [/go/src/github.com/nmiyake/echgo2/out/build/echgo2/0.0.2-4-gc607245.dirty/linux-amd64/echgo2 -type invalid foo] failed with error exit status 1. Output: invalid echo type: invalid
FAIL
FAIL	github.com/nmiyake/echgo2/integration_test	3.021s
```
...
➜ go test -v ./integration_test
=== RUN   TestInvalidType
--- PASS: TestInvalidType (1.81s)
PASS
ok  	github.com/nmiyake/echgo2/integration_test	1.810s
```
...
ok  	github.com/nmiyake/echgo2/integration_test	1.580s
```
...
[master 5198431] Add integration tests
