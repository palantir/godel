...
--- PASS: TestInvalidType (0.53s)
PASS
ok  	github.com/nmiyake/echgo2/integration_test	0.537s
```
...
--- FAIL: TestInvalidType (0.54s)
	integration_test.go:23: cmd [/go/src/github.com/nmiyake/echgo2/out/build/echgo2/0.0.2-4-g1ec1a1e.dirty/linux-amd64/echgo2 -type invalid foo] failed with error exit status 1. Output: invalid echo type: invalid
FAIL
FAIL	github.com/nmiyake/echgo2/integration_test	0.542s
```
...
PASS
ok  	github.com/nmiyake/echgo2/integration_test	0.216s
```
...
[master 253c06e] Add integration tests
