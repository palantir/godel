...
PASS
ok  	github.com/nmiyake/echgo2/integration_test	0.567s
```
...
=== RUN   TestInvalidType
"invalid echo type: invalid\n"
--- FAIL: TestInvalidType (0.55s)
	integration_test.go:23: cmd [/go/src/github.com/nmiyake/echgo2/out/build/echgo2/0.0.2-4-g85105f6.dirty/linux-amd64/echgo2 -type invalid foo] failed with error exit status 1. Output: invalid echo type: invalid
FAIL
FAIL	github.com/nmiyake/echgo2/integration_test	0.554s
```
...
PASS
ok  	github.com/nmiyake/echgo2/integration_test	0.223s
```
...
[master 9ee657c] Add integration tests
