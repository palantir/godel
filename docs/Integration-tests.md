...
PASS
ok  	github.com/nmiyake/echgo2/integration_test	2.343s
```
...
=== RUN   TestInvalidType
"invalid echo type: invalid\n"
--- FAIL: TestInvalidType (2.30s)
	integration_test.go:23: cmd [/go/src/github.com/nmiyake/echgo2/out/build/echgo2/0.0.2-5-ga863004.dirty/linux-amd64/echgo2 -type invalid foo] failed with error exit status 1. Output: invalid echo type: invalid
FAIL
FAIL	github.com/nmiyake/echgo2/integration_test	2.300s
```
...
ok  	github.com/nmiyake/echgo2/integration_test	1.396s
```
...
[master db98a07] Add integration tests
