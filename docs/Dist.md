...
Finished building echgo2 for linux-amd64 (0.202s)
...
Finished building echgo2 for darwin-amd64 (0.201s)
...
[master 463c056] Specify dist configuration
...
```
➜ ./godelw dist
Building echgo2 for darwin-amd64 at out/build/echgo2/0.0.1-1-g463c056/darwin-amd64/echgo2
Building echgo2 for linux-amd64 at out/build/echgo2/0.0.1-1-g463c056/linux-amd64/echgo2
Finished building echgo2 for darwin-amd64 (0.236s)
Finished building echgo2 for linux-amd64 (0.242s)
Creating distribution for echgo2 at out/dist/echgo2/0.0.1-1-g463c056/os-arch-bin/echgo2-0.0.1-1-g463c056-darwin-amd64.tgz, out/dist/echgo2/0.0.1-1-g463c056/os-arch-bin/echgo2-0.0.1-1-g463c056-linux-amd64.tgz
Finished creating os-arch-bin distribution for echgo2
```
...
```
➜ ./godelw dist --force
Building echgo2 for darwin-amd64 at out/build/echgo2/0.0.1-1-g463c056.dirty/darwin-amd64/echgo2
Building echgo2 for linux-amd64 at out/build/echgo2/0.0.1-1-g463c056.dirty/linux-amd64/echgo2
Finished building echgo2 for linux-amd64 (0.235s)
Finished building echgo2 for darwin-amd64 (0.236s)
Creating distribution for echgo2 at out/dist/echgo2/0.0.1-1-g463c056.dirty/bin/echgo2-0.0.1-1-g463c056.dirty.tgz
Finished creating bin distribution for echgo2
Creating distribution for echgo2 at out/dist/echgo2/0.0.1-1-g463c056.dirty/os-arch-bin/echgo2-0.0.1-1-g463c056.dirty-darwin-amd64.tgz, out/dist/echgo2/0.0.1-1-g463c056.dirty/os-arch-bin/echgo2-0.0.1-1-g463c056.dirty-linux-amd64.tgz
Finished creating os-arch-bin distribution for echgo2
```
...
Building echgo2 for darwin-amd64 at out/build/echgo2/0.0.1-1-g463c056.dirty/darwin-amd64/echgo2
Building echgo2 for linux-amd64 at out/build/echgo2/0.0.1-1-g463c056.dirty/linux-amd64/echgo2
Finished building echgo2 for linux-amd64 (0.244s)
...
out/dist
`-- echgo2
    `-- 0.0.1-1-g463c056.dirty
        `-- bin
            |-- echgo2-0.0.1-1-g463c056.dirty
            |   |-- bin
            |   |   |-- darwin-amd64
            |   |   |   `-- echgo2
            |   |   `-- linux-amd64
            |   |       `-- echgo2
            |   `-- timestamp.txt
            `-- echgo2-0.0.1-1-g463c056.dirty.tgz
...
[DRY RUN] Building echgo2 for darwin-amd64 at out/build/echgo2/0.0.1-1-g463c056/darwin-amd64/echgo2
[DRY RUN] Run: /usr/local/go/bin/go build -o /go/src/github.com/nmiyake/echgo2/out/build/echgo2/0.0.1-1-g463c056/darwin-amd64/echgo2 -ldflags -X main.version=0.0.1-1-g463c056 ./. with additional environment variables [GOOS=darwin GOARCH=amd64]
[DRY RUN] Finished building echgo2 for darwin-amd64 (0.000s)
[DRY RUN] Building echgo2 for linux-amd64 at out/build/echgo2/0.0.1-1-g463c056/linux-amd64/echgo2
[DRY RUN] Run: /usr/local/go/bin/go build -o /go/src/github.com/nmiyake/echgo2/out/build/echgo2/0.0.1-1-g463c056/linux-amd64/echgo2 -ldflags -X main.version=0.0.1-1-g463c056 ./. with additional environment variables [GOOS=linux GOARCH=amd64]
[DRY RUN] Finished building echgo2 for linux-amd64 (0.000s)
[DRY RUN] Creating distribution for echgo2 at out/dist/echgo2/0.0.1-1-g463c056/os-arch-bin/echgo2-0.0.1-1-g463c056-darwin-amd64.tgz, out/dist/echgo2/0.0.1-1-g463c056/os-arch-bin/echgo2-0.0.1-1-g463c056-linux-amd64.tgz
