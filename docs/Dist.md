...
[DRY RUN] Run: /usr/local/go/bin/go build -o /go/src/github.com/nmiyake/echgo2/out/build/echgo2/0.0.1-1-g8ad3410/darwin-amd64/echgo2 -ldflags -X main.version=0.0.1-1-g8ad3410 ./. with additional environment variables [GOOS=darwin GOARCH=amd64]
...
[DRY RUN] Run: /usr/local/go/bin/go build -o /go/src/github.com/nmiyake/echgo2/out/build/echgo2/0.0.1-1-g8ad3410/linux-amd64/echgo2 -ldflags -X main.version=0.0.1-1-g8ad3410 ./. with additional environment variables [GOOS=linux GOARCH=amd64]
