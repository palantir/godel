...
func NewBintrayPublisherCreator() Creator {
	return NewCreator(BintrayPublishTypeName, func() distgo.Publisher {
		return &bintrayPublisher{}
	})
}

func (p *bintrayPublisher) TypeName() (string, error) {
	return BintrayPublishTypeName, nil
}
...
func (p *bintrayPublisher) RunPublish(productTaskOutputInfo distgo.ProductTaskOutputInfo, cfgYML []byte, flagVals map[distgo.PublisherFlagName]interface{}, dryRun bool, stdout io.Writer) error {
	...
	if err := SetConfigValue(flagVals, bintrayPublisherProductFlag, &cfg.Product); err != nil {
		return err
	}
	if cfg.Product == "" {
	...
	if err := SetConfigValues(flagVals,
	...
	mavenProductPath := MavenProductPath(productTaskOutputInfo, groupID)
...
func (p *bintrayPublisher) publish(productTaskOutputInfo distgo.ProductTaskOutputInfo, cfg BintrayPublishConfig, dryRun bool, stdout io.Writer) error {
...
func (p *bintrayPublisher) addToDownloadsList(productTaskOutputInfo distgo.ProductTaskOutputInfo, cfg BintrayPublishConfig, mavenProductPath string, dryRun bool, stdout io.Writer) error {
