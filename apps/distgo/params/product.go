...
func addDeps(deps map[string]ProductBuildSpec, depProudcts []string, spec ProductBuildSpec, allSpecs map[string]ProductBuildSpec) error {
	for _, product := range depProudcts {
