...
type ManualDistInfo struct {
	// the extension used by the target output generated by the dist script: for example, "tgz", "zip", etc.
	// DistOutputExtension is used to locate the output generated by the dist script. The output should be a file of
	// the form "{{product-name}}-{{version}}.{{DistOutputExtension}}". If DistOutputExtension is empty, it is
	// assumed that the output has no extension and is of the form "{{product-name}}-{{version}}".
	DistOutputExtension string
}
