...
var defaultPluginsConfig = config.PluginsConfig{
	...
	Plugins: config.ToSinglePluginConfigs([]config.SinglePluginConfig{
		...
		},
		{
			LocatorWithResolverConfig: config.ToLocatorWithResolverConfig(config.LocatorWithResolverConfig{
				Locator: config.ToLocatorConfig(config.LocatorConfig{
					ID: "com.palantir.okgo:check-plugin:1.48.0",
					Checksums: map[string]string{
						"darwin-amd64": "f241dd753a8e59b6ce8d98ccbfb76832149c1ca9be25b501b418d3fe70c68c40",
						"darwin-arm64": "913d9af878f307a12554e56ecc6450d8cf3120903b278aa438116f9c732d8007",
						"linux-amd64":  "7453d6c4bc9dc7678b65fc415565860170090d104bed794bd83dd1eb4866388b",
						"linux-arm64":  "41125fe904f98a251fcc4f6e502c0dddbc2e591d4a6c6f8866d9b5040a600aa0",
					},
				}),
			}),
			Assets: config.ToLocatorWithResolverConfigs([]config.LocatorWithResolverConfig{
				{
					Locator: config.ToLocatorConfig(config.LocatorConfig{
						ID: "com.palantir.godel-okgo-asset-compiles:compiles-asset:1.44.0",
						Checksums: map[string]string{
							"darwin-amd64": "7a7f2776a784fe2a6553779bbc252b64420564cc80da094997c927a876a4fdef",
							"darwin-arm64": "14daa5b607567897da596f72c4f651a07d6d96001d8f9d828e4f70663806f572",
							"linux-amd64":  "9d6d9b43cda25c51e9b3adda206ca0ff82d25e4e2f64d8e4e3f9111d76594599",
							"linux-arm64":  "72e2b4c45ca6722efcf4015c2b5b6ae41d260b149f795f862c74b9a331f09b60",
						},
					}),
				},
				{
				...
				{
					Locator: config.ToLocatorConfig(config.LocatorConfig{
						ID: "com.palantir.godel-okgo-asset-errcheck:errcheck-asset:1.42.0",
						Checksums: map[string]string{
							"darwin-amd64": "08a501fef9a8bbe6f5048b193c7000d9ebbeb9bc27e8a403f357807d941dca88",
							"darwin-arm64": "877ac73b758e63161d5eb519a1df1eb7f254fc09d970424c00f61b6f26110c7d",
							"linux-amd64":  "82864924afeb76653b5dacb5df18c9159cf14b04457aff04ffa3d402202c9dc6",
							"linux-arm64":  "c3766adfd45df40f264ede23bb54040ab1fde06eb2875479b90fc625718af79f",
						},
					}),
				},
				{
